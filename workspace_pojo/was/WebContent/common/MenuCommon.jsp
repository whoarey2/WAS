...
//////////////////세션에 담긴 아디와 비번 담을 변수////////////
	...
	if(session.getAttribute("s_empno")!=null && session.getAttribute("s_emp_pw")!=null){
		s_empno = session.getAttribute("s_empno").toString();
...
<body>
	  ...
	  %>
					<input type="hidden" value="<%= s_empno %>" name="empno">
