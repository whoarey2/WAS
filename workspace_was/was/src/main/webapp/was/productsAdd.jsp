...
<div class="row">
	<div class="col-sm-3">
		<div class="row" style="width: 350px;height: 175px;">
			 <div>
       		 <a href="wasMainMenu.jsp" width="350px"><img src="/erp/images/logo.png" style="width: 350px;"></a>   
    		 </div>
		</div>
		 <div class="row">
    		<div style="background-color:#383E49; width:350px; height:90px; color:#FFFFFF; text-align: center;">
      	    <p>반갑습니다, 사원<strong> 박막례</strong>님</p>
            <h6>최근 접속 시간은...</h6>
         </div>
	</div>
	<div class="row">
    <div style="background-color:#383E49; width:350px; height:700px; color:#FFFFFF">
       <ul class="nav flex-column">
            <div class="list-group" style="width:350px; background-color: #383E49">
            <button type="button" class="btn btn-dark" data-toggle="collapse" data-target="#major" style="width:350px;text-align: center;font-size: x-large;">생산/품질관리</button>
            ...
            <button type="button" class="btn btn-dark" data-toggle="collapse" data-target="#major2" style="width:350px;text-align: center;font-size: x-large;">영업/매출관리</button>
            ...
            <button type="button" class="btn btn-dark" data-toggle="collapse" data-target="#major3" style="width:350px;text-align: center;font-size: x-large;">0000관리</button>
